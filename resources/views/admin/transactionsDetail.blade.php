@vite('resources/css/admin/transactionsDetail.css')
...
<div class="transaction-detail-container d-flex justify-content-center">
    ...
    <div class="order-details-container">
        ...
        <div class="order-container">
            ...
            <p class="text-white">
                {{ $or->userAddress->address->street }}, {{ $or->userAddress->address->district }}, {{ $or->userAddress->address->city }}, {{ $or->userAddress->address->province }},
    ...
    <div class="item-details-container">
        ...
        <div class="product-container">
            <p class="text-white fw-medium">{{ $od->product->user->username }}</p>
