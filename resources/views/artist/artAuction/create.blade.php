...
@section('content')
    ...
    <div class="form-container">
        <div class="form-title">
            ...
            <h1 class="mb-0 .fw-semibold bread-crumb">Add Auction</h1>
        </div>

        <form class="form-create-container" action="{{ route('artist-auction.store') }}" method="POST"
            ...
            <div class="form-create">
                <div class="form-item">
                    ...
                    <input value="{{ old('start_date') }}" type="datetime-local" name="start_date" id="start_date"
                ...
                <div class="form-item">
                    ...
                    <input value="{{ old('end_date') }}" type="datetime-local" name="end_date" id="end_date"
