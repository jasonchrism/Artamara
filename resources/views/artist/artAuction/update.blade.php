...
@section('content')
    ...
    <div class="form-container">
        <div class="form-title">
            <a href="{{ route('artist-auction.index') }}" class="btn" style="color: var(--text-primary);">
                <i class="bi bi-arrow-left"></i>
            </a>
            <h1 class="mb-0 .fw-semibold bread-crumb">Edit Auction</h1>
        </div>

        <form class="form-create-container" action="{{ route('artist-auction.update', $product->product_id) }}" method="POST"
            ...
            <div class="form-create">
                <div class="form-item">
                    ...
                    <input value="{{$product->medium}}" type="text" name="medium" id="medium"
                    ...
                    <input value="{{$product->year}}" type="number" name="year" id="year"
                ...
                <div class="form-item">
                    ...
                    <input value="{{$product->material}}"" type="text" name="material" id="material"
                    ...
                    <div class="measurement">
                        ...
                        <div class="measurement-item">
                            ...
                            <input value="{{$product->length}}"" type="number" name="length" id="length"
                        ...
                        <div class="measurement-item">
                            ...
                            <input value="{{$product->width}}"" type="number" name="width" id="width"
            ...
            <h1 class="mb-0 .fw-semibold bread-crumb">Detail Auction</h1>
            <div class="form-create">
                <div class="form-item">
                    {{-- starting price --}}
                    <label for="start_price">Starting Price</label>
                    <input value="{{$productauction->start_price}}" type="text" name="start_price" id="start_price"
                    ...
                    <input value="{{$productauction->start_date}}" type="datetime-local" name="start_date" id="start_date"
                        class="form-control @error('start_date') is-invalid @enderror" placeholder="Start Date" required>
                    @error('start_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-item">
                    ...
                    <input value="{{$productauction->add_price}}" type="number" name="add_price" id="add_price"
                    ...
                    <input value="{{$productauction->end_date}}" type="datetime-local" name="end_date" id="end_date"
                        class="form-control @error('end_date') is-invalid @enderror" placeholder="End Date" required>
                    @error('end_date')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
