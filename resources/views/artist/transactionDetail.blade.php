...
<div class="transaction-detail-container d-flex justify-content-center">
    ...
    <div class="item-details-container">
        ...
        <div class="item-container">
            <p class="text-white fw-medium buyer-name">Joko Pinurbo</p>
        ...
        <div class="sent-btn-container d-flex justify-content-end">
            <button class="btn btn-primary sent-btn" data-bs-toggle="modal" data-bs-target="#exampleModal">Sent</button>
        </div>
