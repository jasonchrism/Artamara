...
<script>
    ...
    function updateTotalPrice() {
        ...
        // Iterate over all checked product checkboxes
        $('.product-checkbox:checked').each(function() {
            var quantity = parseFloat($(this).attr('data-quantity'));
            var price = parseFloat($(this).data('price'));

            console.log('Checked product:', { quantity, price });
    ...
    $('.artist-checkbox').change(function() {
        ...
        // Trigger change event for all related product checkboxes to update the total price
    ...
    function incrementValue(e) {
        ...
        if (!isNaN(currentVal)) {
            ...
            updateTotalPrice(productId, newVal);
        } else {
            input.val(0);
        }
    }
    ...
    const updateQuantity = function(productId, quantity) {
        ...
        $('.product-checkbox[data-id="' + productId + '"]').attr('data-quantity', quantity);

        // Check if data-quantity attribute was updated correctly
        console.log('Updated data-quantity:', $('.product-checkbox[data-id="' + productId + '"]').attr('data-quantity'));
