                                ...
                                <form action="{{route('front.editprofile.update')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="profile-image col-4 d-flex align-items-center flex-column">
                                            ...
                                            <input type="file" name="profile_picture" id="profile_picture" class="inputfile @error('profile_picture') is-invalid @enderror" />
                                        ...
                                        <div class="profile-form col-8">
                                            ...
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value='{{$user_profile['name']}}''>
                                            ...
                                            <label for="email" class="text-white fw-semibold mb-2 mt-3">{{ __('Email') }}</label>
                                            <p class="profile-subtitle">{{$user_profile['email']}}</p>
        
                                            <label for="username" class="text-white fw-semibold mb-2 mt-3">{{ __('Username') }}</label>
                                            <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{$user_profile['username']}}">
                                            ...
                                            <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{$user_profile['phone_number']}}">
