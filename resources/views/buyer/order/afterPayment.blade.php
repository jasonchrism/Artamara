...
@section('content')
    @if ($status == 'settlement')
        <div class="pt-5 w-100 text-center">
            <h2 class="text-white title">Your order has been successful</h2>
            <svg class="img-order" width="256" height="256" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div class="d-flex justify-content-center">
                <p class="text-secondary-txt mt-2 desc">Your order is being packed by our team and will be
                    shipped to the address you provided shortly</p>
            </div>

            <div class="mt-3 mb-3">
                <a href="{{ route('front.catalog') }}" class="btn btn-primary btn-after">Buy Another Artwork</a>
