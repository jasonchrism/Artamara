                ...
                @method('POST')
                    <div class="product-stock">
                        ...
                        <div class="input-group w-auto justify-content-end align-items-center">
                            ...
                            <input type="number" step="1" max="10" value="1" name="quantity" class="quantity-field border-0 text-center inputcartnumber" style="height: 44px; width: 88px; background-color: var(--bg-overlay-1); color: var(--text-primary);">
