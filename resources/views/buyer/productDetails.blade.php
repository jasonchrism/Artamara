    ...
    <div class="container Product-Details-Container">
        ...
        <div class="row Upper-details-container">
            ...
            <div class="col-md-6 product-detail-right">
                ...
                <p style="font-size: 24px; font-weight:500; color: var(--text-secondary);">{{ $product->user->name }},
                    {{ $product->year }}</p>
                            ...
                            <button class="btn btn-secondary cart" type="submit">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                    ...
                                    <path
                                        ...
                                        stroke="#CEFE06" stroke-width="1.5" stroke-linecap="round"
                                    ...
                                    <path
                                        ...
                                        stroke="#CEFE06" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                    <path d="M2.34375 3.90625H5.46875L7.8125 17.1875H20.3125" stroke="#CEFE06"
        ...
        <div class="row Lower-details-container">
            ...
            <div class="col-md-6 Artwork-About">
                ...
                <div class="Artwork-About-Details row">
                    ...
                    <div class="col-6 col-sm-3">
                        <p>{{ $product->length }} x {{ $product->width }} cm</p>
                    </div>
