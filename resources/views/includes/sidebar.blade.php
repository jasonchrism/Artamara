    ...
    @if (Auth::user()->role == 'ARTIST')
        <nav class="d-grid gap-4">
            ...
            <a href="{{route('artist-sales.index')}}" class="sidebar-item">
                ...
                @endif
                <p class="sidebar-label fw-semibold {{ Request::is('*/artist-sales') ? 'text-white' : '' }}">Art Sales</p>
            </a>
            <a href="{{route('artist-auction.index')}}" class="sidebar-item">
                ...
                @endif
                <p class="sidebar-label fw-semibold {{ Request::is('*/artist-auction') ? 'text-white' : '' }}">Art Auction
                </p>
            </a>
    ...
    @else
        <nav class="d-grid gap-4">
            ...
            <a href="{{route('sales.index')}}" class="sidebar-item">
                ...
                @endif
                <p class="sidebar-label fw-semibold {{ Request::is('*/sales') ? 'text-white' : '' }}">Art Sales</p>
            </a>
            <a href="{{route('auction.index')}}" class="sidebar-item">
                ...
                @endif
                <p class="sidebar-label fw-semibold {{ Request::is('*/auction') ? 'text-white' : '' }}">Art Auction
                </p>
            </a>
            ...
            <a href="#" class="sidebar-item">
                ...
                @endif
                <p class="sidebar-label fw-semibold {{ Request::is('*/user') ? 'text-white' : '' }}">User</p>
            </a>
        </nav>
    @endif
</div>
